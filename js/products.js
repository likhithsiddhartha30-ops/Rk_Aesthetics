...
const PRODUCTS = [
  {
    ...
    features: [
      ...
      "₹591 less than buying the nine separately"
    ]
  },
  {
...
/* Files are not listed here on purpose. They live in a private
   Supabase bucket, and the only way to a download link is a paid
   order: see supabase/schema.sql (product_files) and SETUP.md. */
